                ...
                <tbody class="bg-white divide-y">
                    @forelse ($payment_methods as $payment_method)
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-3 text-sm">
                                <span
                                    class="px-2 py-1 font-semibold leading-tight {{ $payment_method->status == 'active' ? 'text-green-700 bg-green-100 rounded-full' : 'text-red-700 bg-red-100 rounded-full' }}">
