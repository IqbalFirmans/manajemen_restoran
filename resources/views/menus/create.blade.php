                ...
                <form action="{{ route('menus.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="grid gap-6 mb-8 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div class="block text-sm">
                            ...
                            <div>
                                <input type="file" id="image" name="image" class="mt-2 text-sm focus:outline-none form-input @error('image') border-red-600 @enderror"
                            ...
                            <div class="mt-4">
                                ...
                                <img class="w-full h-80 w-30 object-cover mt-2" id="img-preview">
                            </div>
                        </div>
